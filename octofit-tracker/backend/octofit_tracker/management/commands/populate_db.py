...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        client = pymongo.MongoClient(host=settings.DATABASES['default']['CLIENT']['host'], port=settings.DATABASES['default']['CLIENT']['port'])
        ...
        activities.insert_many([
            ...
            {'user': 'Flash', 'activity': 'Running', 'duration': 50},
        ])
